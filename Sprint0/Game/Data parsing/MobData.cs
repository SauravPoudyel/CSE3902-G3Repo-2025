...
namespace Sprint0
{
    public class MobData
    {
        ...
        public enum MobModifiers { MovementSpeed, FiringInterval, AggressionRange, Health, XP}
            ...
            = new Dictionary<(MobDifficulty, MobModifiers), float>
        {
            ...
            { (MobDifficulty.Easy, MobModifiers.XP), 0.75f },
            // Regular
            ...
            { (MobDifficulty.Regular, MobModifiers.XP), 1f },
            // Hard
            ...
            { (MobDifficulty.Hard, MobModifiers.XP), 1.25f },
            // Insane
            ...
            { (MobDifficulty.Insane, MobModifiers.XP), 1.5f },
        };
