...
namespace Sprint0
{
    public class PlayerInventory : IScreen
    {
        ...
        public PlayerInventory(Game1 game)
        {
            ...
            Vector2 statsButtonPos = new Vector2(Globals.SCREENWIDTH - 100, 150);
            Vector2 achievementsButtonPos = new Vector2(Globals.SCREENWIDTH - 100, 250);
            ...
            buttonElements.Add(new StatsButton(content.Load<Texture2D>("UI/AchievementsIcon"), achievementsButtonPos, paramters));
