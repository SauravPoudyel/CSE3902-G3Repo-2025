...
namespace Sprint0
{
    class ShopExitButton : Button
    {
        public ShopExitButton(Texture2D texture, Vector2 vector, Dictionary<string, object> paramters)
        {
        ...
        public override void Update()
        {
            ...
            if (IsClicked())
            {
                new CloseShopCommand().Execute(parameters);
            }
