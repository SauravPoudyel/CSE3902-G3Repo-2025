...
namespace Sprint0
{
    class AchievementsButton : Button
    {
        public AchievementsButton(Texture2D texture, Vector2 vector, Dictionary<string, object> paramters)
        {
        ...
        public override void Update()
        {
            ...
            if (IsClicked())
            {
                new OpenAchievementsCommand().Execute(parameters);
            }
