...
namespace Sprint0
{
    public class Mob : Entity
    {
        ...
        public Mob(ContentManager content) 
        {
            ...
            sprites["Idle"].LoadContent(content, "TDTanksAllSprites", 641, 510, 123, 150, 1);

            AddSprite("Up", new AnimatedSprite(0.3f));
            sprites["Up"].LoadContent(content, "TDTanksAllSprites", 641, 510, 123, 150, 1);

            AddSprite("Down", new AnimatedSprite(0.3f));
            sprites["Down"].LoadContent(content, "TDTanksAllSprites", 641, 510, 123, 150, 1);

            AddSprite("Left", new AnimatedSprite(0.3f));
            sprites["Left"].LoadContent(content, "TDTanksAllSprites", 641, 510, 123, 150, 1); 

            AddSprite("Right", new AnimatedSprite(0.3f));
            sprites["Right"].LoadContent(content, "TDTanksAllSprites", 641, 510, 123, 150, 1);    
